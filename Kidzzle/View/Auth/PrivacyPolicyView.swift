                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        policySection(content: [
                            ...
                            "เราพัฒนาและปรับปรุงระบบแพลตฟอร์มและโมไบล์แอปพลิเคชัน KIDZZLE คิดส์เซิล อยู่ตลอดเวลาเพื่อให้คนไทยเข้าถึงการดูแลสุขภาพของลูกน้อยได้ดียิ่งขึ้น ซึ่งส่วนสำคัญที่จะทำให้ผู้ใช้มีประสบการณ์การใช้งานที่ดีคือการดูแลข้อมูลของลูกน้อย โดยให้ความสำคัญกับความเป็นส่วนตัวของผู้ใช้ และควบคุมความปลอดภัยในการเก็บและเข้าถึงข้อมูล",
